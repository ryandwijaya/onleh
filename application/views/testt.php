                                        ...
                                        <div class="row ">
                                            <div class="col-lg-12">
                                                <div class="hero-slider-content hero-slider-content--left-space p-4" style="background-color: #343a4073!important;">
                                                    <p class="slider-title slider-title--big-light text-light">Nadhira Napoleon</p>
                                            ...
                                            <div class="single-grid-product">
                                                <div class="single-grid-product__image">
                                                    ...
                                                    <a href="<?= base_url() ?>produk/<?= $val['produk_id'] ?>">
                                                        <img src="<?= base_url() ?>assets/upload/images/produk/<?= $val['produk_foto'] ?>" style="width: 200px;height: 210px;" class="img-fluid" alt="">
                                                        <img src="<?= base_url() ?>assets/upload/images/produk/<?= $val['produk_foto'] ?>" style="width: 200px;height: 210px;" class="img-fluid" alt="">
                                                    </a>
