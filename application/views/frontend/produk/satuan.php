								...
								<div class="big-image-wrapper">
									...
									>
										<div class="single-image text-center p-5">
											<img src="<?= base_url() ?>assets/upload/images/produk/<?= $produk['produk_foto'] ?>"
												 class="img-fluid" alt="" style="width: 80%; margin:0 auto;">
										</div>
								...
								<nav>
									<div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
										...
										<a class="nav-item nav-link" id="review-tab" data-toggle="tab" href="#review"
										   role="tab" aria-selected="false">Reviews (1)</a>
									</div>
								</nav>
