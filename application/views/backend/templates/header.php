...
<?php
$pesanan_menunggu = $this->CrudModel->get_pesanan('menunggu')->result_array();
?>
<head>
	<!-- Meta tags -->
	<meta charset="utf-8">
...
<div class="dt-root">
	<div class="dt-root__inner">
        ...
        <a class="dt-brand__logo-link justify-content-center" href="<?= base_url('') ?>">
          <span style="font-size: 16px">Nadhira Napoleon</span>
        </a>
      </span>
					<!-- /brand logo -->
